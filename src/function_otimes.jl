...
otimes(p1::ScaledPauli{N}, p2::Pauli{M}) where {N,M} = Pauli{N+M}((p1.θ + p2.θ)%4, p1.pauli ⊗ p2.pauli)
otimes(p1::Pauli{N}, p2::ScaledPauli{M}) where {N,M} = Pauli{N+M}((p1.θ + p2.θ)%4, p1.pauli ⊗ p2.pauli)
otimes(p1::ScaledPauli{N}, p2::ScaledPauli{M}) where {N,M} = Pauli{N+M}((p1.θ + p2.θ)%4, p1.pauli ⊗ p2.pauli)
